...
export default class EmailService {
    ...
    verificationEmailBuilder(email: string, verificationCode: number) {
        ...
        <body>
            <div class="container">
                ...
                <p>Saludos,<br>El equipo de Brokers App</p>
            </div>
        </body>
        </html>
        `
    ...
    accountRecoveryEmailBuidler(email: string, token: string) {
        const html = `<!DOCTYPE html>
            <html lang="es">
            <head>
                <meta charset="UTF-8">
            ...
            <body>
                <div class="container">
                    ...
                    <p>Hola,</p>
                    <p>Recibimos una solicitud para recuperar tu cuenta. Si fuiste tú quien hizo esta solicitud, por favor haz clic en el siguiente enlace para cambiar tu contraseña:</p>
                    <a href="https://smart-cards-mu.vercel.app/account/recovery/${token}" class="button">Cambiar mi contraseña</a>
                    <p>Si no solicitaste este cambio, puedes ignorar este correo y tu cuenta permanecerá segura.</p>
    ...
    updateEmailBuilder(email: string, verificationCode: number) {
        ...
        <body>
            <div class="container">
                ...
                <p>Si tienes alguna pregunta, no dudes en contactarnos.</p>
                <p>¡Esperamos verte pronto!</p>
                <p>Saludos,<br>El equipo de Broker App</p>
            </div>
        </body>
        </html>
        `
